...
if __name__ == "__main__":
    ...
    parser.add_argument("--gold_file", default=sys.path[0]+r'/processed/test.json', type=str, required=False, help="Gold file")
    ...
    avgF1_file = open(args.out_file + "_avgF1.txt", "w", encoding="utf-8")

    scirex_docids_event_n_path = sys.path[0]+r'/scirex_docids_event_n.json'
    with open(scirex_docids_event_n_path, encoding="utf-8") as f:
    ...
    if args.event_n == "1,2,3,4":
        ...
        avgF1_file.write("print: {} \n".format(" ".join(str_print)))
